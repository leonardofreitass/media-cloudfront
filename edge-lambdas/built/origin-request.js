...
const transformQueryString = (querystring) => {
    const qs = new require$$0.URLSearchParams(querystring);
...
const handler = async (event) => {
    return withTelemetry((telemetry) => {
        ...
        try {
            ...
            const mediaURL = new require$$0.URL(`https://${distributionHost}${request.uri}?token=${token}`);
